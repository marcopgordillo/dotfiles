...
# Exports
export GPG_TTY=$(tty)
export GITHUB_TOKEN="35ccadb2bbaf9984e040752ef10968b9d39a8cb1"

# Add $PATH
export RUBY_BIN="$HOME/.local/share/gem/ruby/3.0.0/bin"
export YARN_PATH="$(yarn global bin)"
NPM_PACKAGES="${HOME}/.npm-packages"
export NPM_PATH=$NPM_PACKAGES/bin
export MANPATH="${MANPATH-$(manpath)}:$NPM_PACKAGES/share/man"
export COMPOSER_PATH="$HOME/.config/composer/vendor/bin"

export PERL_PATH="$HOME/perl5"
export PERL5LIB="$PERL_PATH/lib/perl5${PERL5LIB:+:${PERL5LIB}}"
export PERL_LOCAL_LIB_ROOT="$PERL_PATH${PERL_LOCAL_LIB_ROOT:+:${PERL_LOCAL_LIB_ROOT}}"
export PERL_MB_OPT="--install_base \"$PERL_PATH\""
export PERL_MM_OPT="INSTALL_BASE=$PERL_PATH"

export RUBY_HOST_PROG=$RUBY_BIN/neovim-ruby-host
export PERL_HOST_PROG=$PERL_PATH
export PATH=$RUBY_BIN:$YARN_PATH:$COMPOSER_PATH:$PERL_PATH:$PATH
